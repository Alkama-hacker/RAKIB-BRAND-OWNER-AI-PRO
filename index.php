...
<body>
    ...
    <script>
        ...
        // DIRECT JS FETCH (No Fake Data / No PHP Proxy)
        async function fetchGameData() {
            try {
                ...
                // Remove any quotes or spaces that might cause atob() to fail
                let cleanBase64 = base64Text.replace(/[^A-Za-z0-9+/=]/g, "");
                ...
                document.getElementById('logicOutput').innerText = "WAITING FOR API...";
            }
        }
        ...
        setInterval(() => {
            ...
            if (lastFetchedCycle !== -1 && currentCycle !== lastFetchedCycle) {
                ...
                setTimeout(() => fetchGameData(), 1500); // 1.5s delay for real API to update
            }
